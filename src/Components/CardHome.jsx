...
function CardHome() {
  ...
  return (
    <div className="w-full flex  flex-wrap cards   justify-center   items-center">
      {products.map((product) => (
        <motion.div
          ...
          className="Card flex flex-col justify-between  my-2 mx-2 w-[345px] h-[600px] max-[1026px]:w-[300px] max-sm:w-[100%] max-[770px]:w-[270px] max-[785px]:w-[300px] max-[700px]:w-[245px] max-[650px]:w-[210px] max-[785px]:bg-red-900  group p-2 shadow-lg  bg-white rounded-lg transform transition-all cursor-pointer  hover:shadow-2xl hover:-translate-y-2  duration-300"
        >
          ...
          <div className="p-2">
            ...
            <p className="text-sm mt-2">{product.smallTitle}</p>
          </div>
          <div className="m-2  flex justify-between items-center">
            <Link
              to={`ShowOneProductHome/${product.id}`}
              role="button"
